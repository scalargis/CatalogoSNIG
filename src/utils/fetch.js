...
export const createHeadersFromOptions = (options, addUser) => {
...
export const fetchText = (url, options = {}) => {
    const requestHeaders = createHeadersFromOptions(options, false);
    ...
    return fetch(url, { ...options, headers: requestHeaders })
        ...
        .then(({ status, statusText, headers, body }) => {
            ...
            return Promise.resolve({ status, headers, body, text });
        });
};
...
export const fastFetch = (url, options, timeout = 8000) => {
